...
/// </summary>
public readonly ref struct MassOutbreakSpawner8a(Span<byte> data)
{
    ...
    public ulong CountSeed => ReadUInt64LittleEndian(Data[0x30..]);
    public ulong GroupSeed => ReadUInt64LittleEndian(Data[0x38..]);
